...
def show_post(post_id):
    ...
    displayed_comments = Comment.query.all()
    ...
    return render_template("post.html", post=requested_post, form=comment, all_comments=displayed_comments)
